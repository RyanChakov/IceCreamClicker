...
public class PauseMenu extends Game implements Screen {
	private static final String TAG = "BasicMenuSample";
	private static final int VIRTUAL_WIDTH = 1280;
	private static final int VIRTUAL_HEIGHT = 720;

	private Viewport viewport;
	private TextButton textButton,texts;
	...
	Skin skin=new Skin();
	public PauseMenu(final CookieClicker cookieclicker) {
		game = cookieclicker;
...
*/
		...
		//Text Button
		float firstRowY = 10;
		actor = new Texture(Gdx.files.internal("Quit.png"));
		TextButton.TextButtonStyle tbs = new TextButton.TextButtonStyle();
		tbs.font = font;
		tbs.up = new TextureRegionDrawable(new TextureRegion(actor));
		textButton = new TextButton("", tbs);
		...
		//Back
		actor = new Texture(Gdx.files.internal("BacsK.png"));
		TextButton.TextButtonStyle tbss = new TextButton.TextButtonStyle();
		tbss.font = font;
		tbss.up = new TextureRegionDrawable(new TextureRegion(actor));
		texts = new TextButton("", tbss);
		texts.setPosition(1000,50);
		texts.addListener( new ClickListener() {             
			@Override
			public void clicked(InputEvent event, float x, float y) {
